...
export class DashboardFakeDataService {
  getDashboard(): Observable<DashboardDto> {
    ...
    return of({
      ...
      gardenCard: this.createGardenCard(gardenImages),
      teamCard: this.createTeamCard(teamImages),
      tournamentCard: this.createTournamentCard(),
      rewardsCard: this.createRewardsCard()
    });
  }
